...
public class SQLiteUtil {
    ...
    public static boolean createProjectCodeConfigTable(boolean forceCreate) {
        ...
        DbTableInfo c2 = new DbTableInfo("vo_project_name", "VARCHAR(100)", "包名称", false, false);
        DbTableInfo c3 = new DbTableInfo("vo_super_class", "VARCHAR(100)", "vo 父类", false, false);
        DbTableInfo c4 = new DbTableInfo("vo_path", "VARCHAR(100)", "路径", false, false);
        DbTableInfo c5 = new DbTableInfo("do_path", "VARCHAR(100)", "路径", false, false);
        DbTableInfo c6 = new DbTableInfo("do_package_name", "VARCHAR(100)", "包名称", false, false);
        DbTableInfo c7 = new DbTableInfo("do_super_class", "VARCHAR(100)", "do 父类", false, false);
        DbTableInfo c8 = new DbTableInfo("xml_package_name", "VARCHAR(100)", "包名称", false, false);
        DbTableInfo c9 = new DbTableInfo("xml_path", "VARCHAR(100)", "路径", false, false);
        DbTableInfo c10 = new DbTableInfo("mapper_package_name", "VARCHAR(100)", "包名称", false, false);
        DbTableInfo c11 = new DbTableInfo("mapper_super_class", "VARCHAR(100)", "mapper 父类", false, false);
        DbTableInfo c12 = new DbTableInfo("mapper_path", "VARCHAR(100)", "路径", false, false);
        ...
        DbTableInfo c19 = new DbTableInfo("contr_package_name", "VARCHAR(100)", "包名称", false, false);
        DbTableInfo c20 = new DbTableInfo("contr_path", "VARCHAR(100)", "路径", false, false);
        DbTableInfo c21 = new DbTableInfo("contr_super_path", "VARCHAR(100)", "父类", false, false);
        List<DbTableInfo> tableInfoList = Arrays.asList(c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15, c16, c17, c18, c19, c20, c21);
